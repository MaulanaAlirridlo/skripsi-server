...
def efProcess(tweetList):
  ...
  for doc in tweetList:
    ...
    ensemble.append([F1(doc), F2(doc), F3(doc), F4(doc), F5(doc), F6(doc), 
                   F7(doc), F8(doc), F9(doc), F10(doc), F11(enDoc), F12(enDoc), 
                   F13(doc), F14(doc), F15(doc), F16(doc), F17(doc), F18(doc), 
                   F19(doc), F20(doc), F21(doc), F22(doc), F23(enDoc), F24(enDoc), 
                   F25(enDoc), F26(enDoc), F27(enDoc), F28(enDoc), F29(enDoc), F30(enDoc), 
                   F31(doc), F32(doc), F33(doc), F34(doc), F35(doc), F36(doc), 
                   F37(enDoc)])
  return ensemble